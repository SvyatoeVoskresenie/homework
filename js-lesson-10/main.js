...
const firstName = 'Анастасия';
const lastName = 'Кононова';
...
console.log(`Мена зовут ${firstName} ${lastName}, мне ${age} года. 
Я ученица курса: ${isStudent}`)
...
// ОТВЕТ: будет 123456789falsetrue